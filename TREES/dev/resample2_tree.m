% RESAMPLE2_TREE   Redistributes nodes on tree.
% (trees package)
%
% A sandbox for playing with resample_tree
% Modified from resample_tree, Author: Eilif Muller
%
% tree = resample2_tree (intree, sr, options)
% ------------------------------------------
%
...
% Example
% -------
% resample2_tree (sample_tree, 5, '-s')
%
...
function varargout = resample2_tree (intree, sr, options)
